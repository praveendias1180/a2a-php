# Copied unchanged (below this header) from the A2A Python SDK:
# https://github.com/a2aproject/a2a-python/blob/0d5473c/samples/hello_world_agent.py
# Copyright Google LLC / the A2A Project, Apache License 2.0.
# Used by scripts/run-python-interop.sh as the server the PHP client is tested against.
